...
class Version20220407174248 extends Version
{
    protected $description = "Вопрос-ответ/Настройки(структура)";
  ...
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'LIST_PAGE_URL' => '#SITE_DIR#/question/index.php?ID=#IBLOCK_ID#',
  'DETAIL_PAGE_URL' => '#SITE_DIR#/question/detail.php?ID=#ELEMENT_ID#',
  'SECTION_PAGE_URL' => '#SITE_DIR#/question/list.php?SECTION_ID=#SECTION_ID#',
  'CANONICAL_PAGE_URL' => '',
  'PICTURE' => NULL,
  'DESCRIPTION' => '',
  ...
  array (
    ...
    'NAME' => 'Название',
    'CODE' => 'Символьный код',
    'PROPERTY_IMAGES' => 'Изображение 1',
    'PROPERTY_TITLE_PART_1' => 'Заголовок (чать 1)',
    'PROPERTY_TITLE_PART_2' => 'Заголовок (чать 2)',
    'PROPERTY_BUTTON_TEXT_QUESTION' => 'Текст кнопки "Задать вопрос"',
  ),
  'SEO|edit14' => 
  array (
