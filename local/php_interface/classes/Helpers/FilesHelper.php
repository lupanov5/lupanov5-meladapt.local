...
/**
 * Class FilesHelper - хелпер для работы с файлами и с классами битрикса
 * @package helpers
 */
class FilesHelper
{
    private const PLACEHOLDER = '/local/html/img/placeholder.png';
     ...
     * @return string
     */
    public static function getImageById($id = 0): string
    {
