<section class="melatonin">
    ...
    <div class="melatonin__bg">
        ...
        <img src="/local/templates/meladapt/assets/images/melatonin-bg-3.png" alt="">

    </div>
    <div class="container melatonin__container">

        <div class="promo__head">
            <h1 class="promo__title">Зачем нужен <span>мелатонин?</span></h1>
            <div class="promo__subtitle">Регулятор внутренних часов организма, пик его выработки приходится
                на ночное время, но с возрастом его уровень снижается</div>
        </div>
        ...
        <div class="feat melatonin__feat">
            ...
            <div class="feat__item fadeIn">
                ...
                <div class="feat__text">Способствует необходимому отдыху</div>
            </div>
        </div>
